...
class ProductModel
{
    ...
    public function addProduct($name, $description, $price, $category_id, $image = null)
    {
        ...
        $category_id = ($category_id !== '' && $category_id !== null) ? (int)$category_id : null;
        $image       = $image ? htmlspecialchars(strip_tags((string)$image)) : null;
    ...
    {
        $query = "SELECT p.id, p.name, p.description, p.price, p.image, p.category_id,
    ...
    public function filterProducts($keyword = '', $category_id = '')
    {
        $query = "SELECT p.id, p.name, p.description, p.price, p.image, p.category_id,
                         c.name as category_name
                  FROM product p
